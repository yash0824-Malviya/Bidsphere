...
const NAV_LABEL_KEYS: Record<string, string> = {
  ...
  "PO Operations": "sidebar.poOperations",
  "New PO": "sidebar.newPo",
  GRN: "sidebar.grn",
  Vouchers: "sidebar.vouchers",
  Invoices: "sidebar.invoices",
  Payments: "sidebar.payments",
  "All RFIs": "sidebar.allRfis",
  "Create RFI": "sidebar.createRfi",
  "All RFPs": "sidebar.allRfps",
  "Create RFP": "sidebar.createRfp",
  ...
  "PO Amendments": "sidebar.poAmendments",
  "Supplier Confirmation": "sidebar.supplierConfirmation",
  "Delivery Tracking": "sidebar.deliveryTracking",
  "GRN Monitoring": "sidebar.grnMonitoring",
  "GRN Monitoring (Read Only)": "sidebar.grnMonitoringReadOnly",
  "Invoice Coordination": "sidebar.invoiceCoordination",
